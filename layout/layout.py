...
class TomatoSegmentationApp:
    def __init__(self, root):
        ...
        self.image_rgb = None  # Simpan gambar agar tidak dihapus oleh garbage collector
        ...
        tk.Entry(self.inner_frame, width=25, justify="center").grid(row=2, column=0, columnspan=6, pady=2)
